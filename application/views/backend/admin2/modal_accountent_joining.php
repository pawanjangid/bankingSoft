...
<div class="row" style="width: 100%;padding: 20px;" id="printarea">
    <div style="margin: 20px;">
        ...
        <br>
        Mr./Miss <?php echo $row['name'];?><br>
        With reference to your application and subsequent interview with us, we are pleased to make you an offer of appointment as Accountent at our <?php echo $this->db->get_where('settings', array('type' => 'address'))->row()->description; ?> location.<br>
        <ul>
            <li>
