	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php?admin/hr_manager/do_update/'.$row['employee_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
