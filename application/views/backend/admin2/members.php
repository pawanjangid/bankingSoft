                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_account/<?php echo $row['nidhi_account_id'];?>');">
                                                <i class="entypo-user"></i>
                                    ...
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/member_account/delete/<?php echo $row['nidhi_account_id'];?>>');">
