...
<?php echo form_open(base_url() . 'index.php?admin/take_emi/take/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<script type="text/javascript">
    function get_detail_account() {
      var account_no = document.getElementById('account_no').value
        $.ajax({
            url: '<?php echo base_url();?>index.php?admin/get_applicant_detail/' + account_no ,
