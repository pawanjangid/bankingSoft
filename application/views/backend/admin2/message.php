...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="unpaid">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/message/single' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                <div class="row">
                    <div class="col-md-6">
        ...
        <div class="tab-pane" id="paid">
            ...
            <?php echo form_open(base_url() . 'index.php?admin/message/bulk_sms' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
            <br>
            <div class="row">
    ...
    <div class="tab-pane" id="paid22">
        ...
        <?php echo form_open(base_url() . 'index.php?admin/message/whole_sms' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
        <br>
        <div class="row">
            <div class="col-md-1"></div>
            <div class="form-group">
