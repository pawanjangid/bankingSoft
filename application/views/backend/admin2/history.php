        ...
        <div class="tab-content">
            <div class="tab-pane active" id="home">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        <?php 
                                $user_approved   =   $this->db->get_where('user' , array('application_at' => '5'))->result_array();
                                $count = 1;
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                        ...
                                        <li>
                                            <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_track_loan/<?php echo $row['application_id'];?>');">
                                                <i class="entypo-pencil"></i>
                                                    <?php echo get_phrase('Track_loan');?>
                                                </a>
                                        </li>
                                    </ul>
                                </div>
