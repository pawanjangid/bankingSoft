...
<?php
$employees   =   $this->db->get_where('accountent' , array('employee_id' => $param2 ))->result_array();
...
$salary_detail = $this->db->get_where('employ_salary',  array('employee_id' =>  $param2,'authentic' => '1' , 'authentic_type' => '2'))->result_array();
    ...
    <section class="profile-info-tabs">
        ...
        <div class="row">
            ...
            <div class="">
                ...
                <?php $salary_detail = $this->db->get_where('employ_salary',  array('employee_id' =>  $param2,'authentic' => '1' , 'authentic_type' => '2'))->result_array();
$i = sizeof($salary_detail);
