...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#unpaid" data-toggle="tab">
                    <span class="hidden-xs"><?php echo "Single Borrower";?></span>
                </a>
            </li>
            <li>
                <a href="#paid" data-toggle="tab">
                    <span class="hidden-xs"><?php echo "Category wise";?></span>
                </a>
            </li>
            <li>
                <a href="#paid22" data-toggle="tab">
                    <span class="hidden-xs"><?php echo "All Borrower";?></span>
                </a>
            </li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="unpaid">
                ...
                <?php echo form_open(base_url() . 'index.php?accountent/message/single' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default panel-shadow" data-collapsed="0">
                            <div class="panel-heading">
                                <div class="panel-title"><?php echo "Borrower Detail";?></div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Borrower');?></label>
                                <div class="col-sm-9">
        ...
        <div class="tab-pane" id="paid">
            ...
            <?php echo form_open(base_url() . 'index.php?accountent/message/bulk_sms' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
            <br>
            <div class="row">
    ...
    <div class="tab-pane" id="paid22">
        ...
        <?php echo form_open(base_url() . 'index.php?accountent/message/whole_sms' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
        <br>
        <div class="row">
            <div class="col-md-1"></div>
            <div class="form-group">
...
<script type="text/javascript">
    function get_class_students(class_id) {
        $.ajax({
            url: '<?php echo base_url();?>index.php?accountent/get_class_students/' + class_id ,
...
<script type="text/javascript">
    function get_class_students_mass(class_id) {
        ...
        $.ajax({
            url: '<?php echo base_url();?>index.php?accountent/get_class_students_mass/' + class_id ,
            success: function(response)
            {
