<?php 
$edit_data	=	$this->db->get_where('employees' , array('category_id' => $param2) )->result_array();
    ...
    <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?accountent/employee_salary/add/'.$param2 , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
