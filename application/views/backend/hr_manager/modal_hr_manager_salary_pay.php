<?php 
$edit_data	=	$this->db->get_where('hr_manager' , array('employee_id' => $param2) )->result_array();
                ...
                <?php echo form_open(base_url() . 'index.php?hr_manager/authentic_salary/add/'.$param2 , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" name="authentic_type" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="1" autofocus>
                     <div class="form-group">
