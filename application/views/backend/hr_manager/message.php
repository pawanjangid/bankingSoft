...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="unpaid">
                ...
                <?php echo form_open(base_url() . 'index.php?hr_manager/message/single' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                <div class="row">
                    <div class="col-md-6">
        ...
        <div class="tab-pane" id="paid">
            ...
            <?php echo form_open(base_url() . 'index.php?hr_manager/message/bulk_sms' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
            <br>
            <div class="row">
    ...
    <div class="tab-pane" id="paid22">
        ...
        <?php echo form_open(base_url() . 'index.php?hr_manager/message/whole_sms' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
        <br>
        <div class="row">
            <div class="col-md-1"></div>
            <div class="form-group">
...
<script type="text/javascript">
    function get_class_students(class_id) {
        $.ajax({
            url: '<?php echo base_url();?>index.php?hr_manager/get_class_students/' + class_id ,
...
<script type="text/javascript">
    function get_class_students_mass(class_id) {
        ...
        $.ajax({
            url: '<?php echo base_url();?>index.php?hr_manager/get_class_students_mass/' + class_id ,
            success: function(response)
            {
