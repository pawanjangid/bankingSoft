        ...
        <div class="row">
            ...
            <div class="">
               ...
               <tr>
                   ...
                   <td style="border : 1px solid black;border-collapse: collapse;">
                        <?php echo $this->db->get_where('employee_category', array('category_id' =>  $row['employee_category_id']))->row()->name; ?>
                   </td>
                   <td style="border : 1px solid black;border-collapse: collapse;">
                       Account Number :
                   </td>
...
$salary_detail = $this->db->get_where('employ_salary',  array('employee_id' =>  $param2,'authentic' => '0'))->result_array();
$i = sizeof($salary_detail);
$str = $salary_detail[$i-1]['date'];

   //$str1 = $salary_detail[$i-1]['date'];
  // preg_match("|(.*?)/(.*?)/(.*?)|", $str1, $match);
  // $str = $match[2]."/".$match[1]."/".$match[2];
   
    //echo $your_format = date("M", strtotime($str)) . ' ' . substr($str1, -4);
    echo date('M-Y',$salary_detail[$i-1]['payment_date']);
     //strtotime() expects mm/dd/yyyy
    //returns 18 Aug 2008
?>
        </h3>
    ...
    <section class="profile-info-tabs">
        ...
        <div class="row">
            ...
            <div class="">
                ...
                <?php $salary_detail = $this->db->get_where('employ_salary',  array('employee_id' =>  $param2))->result_array();
$i = sizeof($salary_detail);
