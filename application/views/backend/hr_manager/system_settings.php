<hr />
    ...
    <div class="row">
    <?php echo form_open(base_url() . 'index.php?hr_manager/system_settings/do_update' , 
...
<script type="text/javascript">
    $(".gallery-env").on('click', 'a', function () {
        skin = this.id;
        $.ajax({
            url: '<?php echo base_url();?>index.php?hr_manager/system_settings/change_skin/'+ skin,
            success: window.location = '<?php echo base_url();?>index.php?hr_manager/system_settings/'
        });
});
</script>