<?php 
$edit_data		=	$this->db->get_where('business_manager' , array('employee_id' => $param2) )->result_array();
	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php?hr_manager/business_manager/do_update/'.$row['employee_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
