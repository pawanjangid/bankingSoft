        ...
        <br>
                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?hr_manager/classes/delete/<?php echo $row['class_id'];?>');">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?hr_manager/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
