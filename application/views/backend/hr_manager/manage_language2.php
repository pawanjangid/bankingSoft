...
<button onClick="copy_language()">copy</button>
          ...
          <div id="copy_from_<?php echo $row['phrase_id'];?>"><?php echo ucwords(str_replace( '_' ,' ',$row['phrase']));?></div>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url().'index.php?hr_manager/manage_language/add_phrase/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
			...
			<div class="tab-pane box" id="add_lang" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url().'index.php?hr_manager/manage_language/add_language/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
