	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/forward_to_second/insert/'.$row['application_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Check_Number');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control" name="check_number" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Id_Number');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control" name="id_number" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
						</div>
					</div>
					<div class="form-group">
					...
					<div id="append_visit">
					<div class="form-group" id="visit_section">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('visit_photos');?></label>
				...
				<center>
					<div id="add_visit" class="btn btn-white">
						+Visit_photos
					</div>
				</center>
					...
					<div id="append">
					<div class="form-group" id="other_document_section">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Other_Documents');?></label>
							...
							<div class="fileinput fileinput-new" data-provides="fileinput">
								...
								<div>
									<span class="btn btn-white btn-file">
										<span class="fileinput-new">Select image</span>
										<span class="fileinput-exists">Change</span>
										<input type="file" name="other_document[]" accept="image/*">
									</span>
									<a href="#" class="btn btn-orange fileinput-exists" data-dismiss="fileinput">Remove</a>
								</div>
							</div>
				...
				<center>
					<div id="add_document" class="btn btn-white">
						+Other Documents
					</div>
				</center>
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo get_phrase('Forward');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
...
$(document).ready(function(){
    $("#add_visit").click(function(){
        $("#visit_section").clone().appendTo("#append_visit");
    });
});
</script>
<script>
$(document).ready(function(){
    $("#add_document").click(function(){
        $("#other_document_section").clone().appendTo("#append");
    });
});
</script>