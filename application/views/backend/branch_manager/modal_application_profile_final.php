                ...
                <table class="table table-bordered" style="width: 100%;">
                    ...
                    <tr style="width: 100%;">
                     ...
                     <tr style="width: 100%;">
                        ...
                        <td colspan="2"><b><?php echo $this->db->get_where('employee', array('employee_id' => $row['agent_id']))->row()->name;?></b></td>
                    </tr>
                    <tr style="width: 100%;">
                        <td><?php echo get_phrase('Code');?></td>
                        <td colspan="2"><b><?php echo $this->db->get_where('employee', array('employee_id' => $row['agent_id']))->row()->code;?></b></td>
                    </tr>
                    <tr style="width: 100%;">
