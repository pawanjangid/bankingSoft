...
<div class="row" style="font-size: 14px;">
        ...
        <div class="col-sm-3">
            <?php echo form_open(base_url() . 'index.php?admin/loan_entry_approval/approve' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
            <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label" style="font-size: 14px;color: green;"><?php echo get_phrase('Loan_Id');?></label>
                        <div class="col-sm-9">
                           <input type="text" class="form-control" name="loan_code" id="loan_code" oninput="get_loandata(this.value);"  value=""  autofocus>
            ...
            <center>
                <button type="submit" class="btn btn-info" style="width: 100px;font-size: 14px;font-weight: 600;"><?php echo get_phrase('Approve_It');?></button>
            </center>
            <?php echo form_close();?>
        </div>
</div>
