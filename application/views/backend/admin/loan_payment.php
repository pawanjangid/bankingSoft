...
<div class="row" style="font-size: 14px;">
		...
		<div class="col-sm-12">
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-3">
                           <input type="text" class="form-control" name="member_code" id="member_code" disabled="disabled" value=""  autofocus>
                        </div>
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="loan_type" id="loan_type" class="form-control" disabled="disabled" value="" autofocus>
                        </div>
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="roi" id="roi_max" class="form-control" value="" disabled="disabled" autofocus>
                        </div>
    ...
    if (this.readyState == 4 && this.status == 200) {
        var obj = JSON.parse(this.responseText);
            //document.getElementById('demo').innerHTML = this.responseText;
             ...
             //document.getElementById('due_amount').value = total-obj.paid_amount;
             ...
             var table = '';
             var emi = document.getElementById('emi').value;
             var num = document.getElementById('max_term').value;
             for (var i; i <= num; i++) {
                table += '<tr>';
                 table += '<td>'+i+'</td>';
                 table += '<td></td>';
