...
<div class="row" style="font-size: 14px;">
		<div class="col-sm-12">
			<?php echo form_open(base_url() . 'index.php?admin/loan_emi_received_report' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
			<div class="col-sm-6">
			<div class="form-group">
                        ...
                        <button type="submit" class="btn btn-info col-sm-3" style="width: 300px;font-size: 14px;font-weight: 600;"><?php echo get_phrase('Get_Sanction_Letter');?></button>
            </div>
            <?php echo form_close();?>
			</div>
		</div>
