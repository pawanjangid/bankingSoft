...
<hr>
<div class="row">
<?php $commission = $this->db->get_where('commission', array('commission_id' => $data_id))->result_array(); ?>
<?php foreach ($commission as $row): ?>
		<div class="col-sm-12">
			<?php echo form_open(base_url() . 'index.php?admin/commission/do_update/' . $data_id , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
			<div class="col-sm-4">
                <div class="form-group">
                        ...
                        <div class="col-sm-3">
                           <select name="rank_id" class="form-control select" id="rank" required="required" onchange="put2values(this.value)">
                              ...
                              <?php $rank = $this->db->get('rank')->result_array(); ?>
                                <?php foreach ($rank as $row1) : ?>
                                <option value="<?php echo $row['rank_id']; ?>" <?php if ($row['rank_id']==$row1['rank_id']) { echo 'selected="selected"'; } ?>><?php echo $row1['rank'];?></option>
                                <?php endforeach; ?>
                          </select>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="Designation" id="Designation" required="required" value="<?php echo $this->db->get_where('rank', array('rank_id' => $row['rank_id']))->row()->Designation; ?>" autofocus>
                        </div>           
            </div>
           <div style="text-align: center;">Plan Detail</div>
                        ...
                        <div class="col-sm-9">
                           <select name="product_id" class="form-control select" id="product_id" required="required">
                              ...
                              <?php $plans = $this->db->get('product_master')->result_array(); ?>
                                ...
                                <option value="<?php echo $row3['product_id']; ?>" <?php if ($row['product_id']==$row3['product_id']) { echo 'selected="selected"'; } ?>><?php echo $row3['plan_name'];?></option>
                                <?php endforeach; ?>
                          </select>
                        </div>
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="commission_new_self" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="<?php echo $row['commission_new_self']; ?>" autofocus>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="commission_new_team" name="commission_new_team" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="<?php echo $row['commission_new_team']; ?>" autofocus>
                        </div>
            </div>
            <center>OLD</center>
            <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="commission_old_self" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="<?php echo $row['commission_old_self']; ?>" autofocus>
                        </div>
                        <label for="field-1" class="col-sm-4 control-label" style="font-size: 14px;color: green;" ><?php echo get_phrase('Commission_Team');?></label>
                        
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="commission_old_team" name="commission_old_team" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="<?php echo $row['commission_old_team']; ?>" autofocus>
                        </div>
            </div>
